...
class talallhawa extends StatefulWidget {
  const talallhawa({super.key});

  @override
  State<talallhawa> createState() => _talallhawaState();
}

class _talallhawaState extends State<talallhawa> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("تل الهوى", style: TextStyle(color: Colors.white)),
        centerTitle: true,
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('district', isEqualTo: 'تل الهوى') // جلب مساحات منطقة تل الهوى فقط
            .snapshots(),
