...
//   Future<void> addFavorite(Map<String, dynamic> workspace) async {
//     final favorites = _favoritesCollection;
//     final workspaceId = (workspace['id'] ?? workspace['workspaceId'] ?? '').toString();
//     if (favorites == null || workspaceId.isEmpty) {
//       throw StateError('User must be signed in and workspace must have an id.');
//     }

//     final favoriteData = Map<String, dynamic>.from(workspace);
//     favoriteData['id'] = workspaceId;
//     favoriteData['workspaceId'] = workspaceId;
//     favoriteData['createdAt'] = FieldValue.serverTimestamp();

//     await favorites.doc(workspaceId).set(favoriteData, SetOptions(merge: true));
//   }
...
//     return favorites.orderBy('createdAt', descending: true).snapshots().map((snapshot) {
