      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: [
            ...
            // --- زر تبديل الحساب (تم تعديله ليُظهر القائمة حتماً) ---
            ListTile(
              leading: const Icon(Icons.swap_horiz),
              title: const Text("تبديل الحساب"),
              onTap: () async {
                Navigator.pop(context); // إغلاق الـ Drawer فقط
                try {
                  // دالة التبديل تقوم بعمل disconnect وفتح القائمة تلقائياً
            ...
            // --- زر تسجيل الخروج (تم تعديله ليعتمد على الـ StreamBuilder) ---
            ListTile(
              ...
              onTap: () async {
                Navigator.pop(context); // إغلاق الـ Drawer فقط
                try {
                  // بمجرد الخروج، الـ StreamBuilder في الـ main.dart سيعيدك لصفحة البداية تلقائياً
