...
class hamad extends StatefulWidget {
  ...
  @override
  State<hamad> createState() => _hamadState();
}

class _hamadState extends State<hamad> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("مدينة حمد والقرارة", style: TextStyle(color: Colors.white)),
        centerTitle: true,
        iconTheme: const IconThemeData(color: Colors.white),
      ),
      backgroundColor: Colors.white,
      // استخدام StreamBuilder لجلب البيانات مباشرة من الفايرستور
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('workspaces')
            .where('district', isEqualTo: 'مدينة حمد والقرارة') // جلب مساحات هذه المنطقة فقط
            .snapshots(),
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              return WorkspaceCard(
                ...
                // حل المشكلة: تمرير حقل الـ onTap والانتقال لصفحة التفاصيل بنجاح
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
