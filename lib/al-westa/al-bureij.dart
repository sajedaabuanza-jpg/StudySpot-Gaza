...
class AlBureij extends StatefulWidget {
  const AlBureij({super.key});

  @override
  State<AlBureij> createState() => _AlBureijState();
}

class _AlBureijState extends State<AlBureij> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("البريج", style: TextStyle(color: Colors.white)),
        centerTitle: true,
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('district', isEqualTo: 'البريج')
            .snapshots(),
