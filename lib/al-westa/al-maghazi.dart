...
class AlMaghazi extends StatefulWidget {
  const AlMaghazi({super.key});

  @override
  State<AlMaghazi> createState() => _AlMaghaziState();
}

class _AlMaghaziState extends State<AlMaghazi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("المغازي", style: TextStyle(color: Colors.white)),
        centerTitle: true,
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('district', isEqualTo: 'المغازي')
            .snapshots(),
